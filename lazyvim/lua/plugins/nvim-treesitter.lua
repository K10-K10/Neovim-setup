...
--             LazyVim.error({"Setting custom compilers for `nvim-treesitter` is no longer supported.", "",
--                            "For more info, see:",
...
--       group = vim.api.nvim_create_augroup("lazyvim_treesitter", {
--         clear = true
--       }),
...
--           return f.enable ~= false and not (type(f.disable) == "table" and vim.tbl_contains(f.disable, lang)) and
--                    LazyVim.treesitter.have(ft, query)
--         end
--         -- highlighting
...
return {
  "nvim-treesitter/nvim-treesitter",
  opts = {
    ensure_installed = {"git_config", "gitcommit", "git_rebase", "gitignore", "gitattributes", "gleam", "dockerfile",
                        "cmake", "cpp", "astro", "css"}
  }
}
